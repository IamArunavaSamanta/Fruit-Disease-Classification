        ...
        if st.session_state.logged_in:
            ...
            if uploaded_file is not None:
                ...
                if label == 'Apple___Black_rot':
                    st.warning("Black rot is a silent killer. It starts with small dark spots on leaves and fruits, then spreads rapidly, causing fruit rot and branch dieback. If ignored, it can destroy your entire orchard and cut your income to zero. Act now: Remove infected parts, apply the right fungicides, and follow strict orchard hygiene. 📩 Contact us: Email – arunavasamanta001@gmail.com, WhatsApp – [+91-9330658166] for the best solution before it’s too late.")
